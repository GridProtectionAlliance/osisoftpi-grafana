...
function () {
  ...
  AnnotationsQueryCtrl.prototype.templateChanged = function () {// do nothing
  };
...
/* harmony import */ var components_QueryEditorModeSwitcher__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! components/QueryEditorModeSwitcher */ "./components/QueryEditorModeSwitcher.tsx");
...
function (_super) {
  ...
  function PIWebAPIQueryEditor(props) {
    ...
    _this.getElementSegments = function (index) {
      ...
      if (!query.isPiPoint) {
        ...
        if (!((_d = findQuery.path) === null || _d === void 0 ? void 0 : _d.length)) {
          return Promise.resolve([]);
        }
      }
    ...
    _this.buildFromTarget = function (query, segmentsArray, attributesArray) {
      ...
      if (splitElements.length > 1 || splitElements.length === 1 && splitElements[0] !== '') {
        ...
        Object(lodash__WEBPACK_IMPORTED_MODULE_1__["each"])(splitElements, function (item, index) {
          segmentsArray.push({
            label: item,
            value: {
              value: item,
        ...
        return _this.getElementSegments(segmentsArray.length + 1).then(function (elements) {
    ...
    _this.segmentChangeValue = function (segments) {
      ...
      _this.setState({
        ...
        return _this.onChange(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, query), {
          segments: segments
        }));
      });
    };
    ...
    _this.onChange = function (query) {
      ...
      if (query.rawQuery) {
        query.target = (_a = query.query) !== null && _a !== void 0 ? _a : '';
  ...
  PIWebAPIQueryEditor.prototype.getSegmentPathUpTo = function (segments, index) {
    ...
    return Object(lodash__WEBPACK_IMPORTED_MODULE_1__["reduce"])(arr, function (result, segment) {
      ...
      if (!((_a = segment.value.value) === null || _a === void 0 ? void 0 : _a.startsWith('-Select'))) {
  ...
  PIWebAPIQueryEditor.prototype.getSelectedPIServer = function () {
    ...
    return this.piServer.length > 0 ? (_a = this.piServer[0].value) === null || _a === void 0 ? void 0 : _a.webId : webID;
  };
  /**
  ...
  PIWebAPIQueryEditor.prototype.textEditorChanged = function () {
    var _this = this;
    ...
    if (splitElements.length > 1 || splitElements.length === 1 && splitElements[0] !== '') {
      ...
      this.getElementSegments(segments.length + 1).then(function (elements) {
        if (elements.length > 0) {
          segments.push({
            label: 'Select Element',
            value: {
  ...
  PIWebAPIQueryEditor.prototype.render = function () {
    ...
    var metricsQuery = Object(lodash__WEBPACK_IMPORTED_MODULE_1__["defaults"])(queryProps, _types__WEBPACK_IMPORTED_MODULE_5__["defaultQuery"]);
    ...
    return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_2___default.a.Fragment, null, !rawQuery && react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", {
      ...
      onChange: function onChange(event) {
        return _onChange(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, metricsQuery), {
      ...
      return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_3__["SegmentAsync"], {
        ...
        onChange: function onChange(item) {
          return _this.onSegmentChange(item, index);
        },
      ...
      isRaw: false,
      onChange: function onChange(value) {
        _onChange(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, metricsQuery), {
      ...
      return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_3__["Segment"], {
        ...
        onChange: function onChange(item) {
          return _this.onSummaryValueChanged(item, index);
        },
...
/*!******************************!*\
  !*** ./components/Forms.tsx ***!
  \******************************/
/*! exports provided: QueryField, QueryRowTerminator, QueryInlineField, QueryEditorRow, QueryRawInlineField, QueryRawEditorRow */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "QueryRawInlineField", function() { return QueryRawInlineField; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "QueryRawEditorRow", function() { return QueryRawEditorRow; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "../node_modules/tslib/tslib.es6.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _grafana_ui__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @grafana/ui */ "@grafana/ui");
...
var QueryRawInlineField = function QueryRawInlineField(_a) {
  var props = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__rest"])(_a, []);

  return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(QueryRawEditorRow, null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(QueryField, Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, props)));
};
...
/*!************************************************!*\
  !*** ./components/QueryEditorModeSwitcher.tsx ***!
  \************************************************/
/*! exports provided: QueryEditorModeSwitcher */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "QueryEditorModeSwitcher", function() { return QueryEditorModeSwitcher; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "../node_modules/tslib/tslib.es6.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _grafana_ui__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @grafana/ui */ "@grafana/ui");
...
var QueryEditorModeSwitcher = function QueryEditorModeSwitcher(_a) {
  var isRaw = _a.isRaw,
      onChange = _a.onChange;
  ...
  if (isRaw) {
    return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_1___default.a.Fragment, null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_2__["Button"], {
    ...
    }), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_2__["ConfirmModal"], {
      isOpen: isModalOpen,
    ...
    return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_2__["Button"], {
...
function (_super) {
  ...
  function PiWebAPIDatasource(instanceSettings) {
    ...
    _this.backendSrv = Object(_grafana_runtime__WEBPACK_IMPORTED_MODULE_3__["getBackendSrv"])();
    ...
    options.targets = Object(lodash__WEBPACK_IMPORTED_MODULE_1__["map"])(options.targets, function (target) {
      var tar = {
        ...
        attributes: Object(lodash__WEBPACK_IMPORTED_MODULE_1__["map"])(target.attributes, function (att) {
          ...
          return _this.templateSrv.replace(((_a = att.value) === null || _a === void 0 ? void 0 : _a.value) || att, options.scopedVars);
        }),
  ...
  PiWebAPIDatasource.prototype.metricFindQuery = function (query, queryOptions) {
    ...
    if (queryOptions.isPiPoint) {
      ...
      query.path = this.templateSrv.replace(query.path);
      query.path = query.path.replace(/\{([^\\])*\}/gm, function (r) {
  ...
  PiWebAPIDatasource.prototype.resolveWebIds = function (query) {
    ...
    Object(lodash__WEBPACK_IMPORTED_MODULE_1__["each"])(query.targets, function (target) {
      ...
      if (hasAttributes) {
        Object(lodash__WEBPACK_IMPORTED_MODULE_1__["each"])(target.attributes, function () {
  ...
  PiWebAPIDatasource.prototype.parsePiPointValueList = function (value, target, isSummary) {
    ...
    Object(lodash__WEBPACK_IMPORTED_MODULE_1__["each"])(value, function (item) {
      // @ts-ignore
      var _a = _this.noDataReplace(isSummary ? item.Value : item, target.summary.nodata, api.parsePiPointValue(isSummary ? item.Value : item, target, isSummary)),
  ...
  PiWebAPIDatasource.prototype.parsePiPointValue = function (value, target, isSummary) {
    ...
    if (!value.Good || target.digitalStates && target.digitalStates.enable) {
      num = !isSummary && _typeof(value.Value) === 'object' ? value.Value.Name : value.Name;
    }
  ...
  PiWebAPIDatasource.prototype.noDataReplace = function (item, noDataReplacementMode, grafanaDataPoint) {
    ...
    if (!item.Good || item.Value === 'No Data' || ((_a = item.Value) === null || _a === void 0 ? void 0 : _a.Name) && ((_b = item.Value) === null || _b === void 0 ? void 0 : _b.Name) === 'No Data') {
  ...
  PiWebAPIDatasource.prototype.getStream = function (query) {
    ...
    Object(lodash__WEBPACK_IMPORTED_MODULE_1__["each"])(query.targets, function (target) {
      ...
      var displayName = target.display ? _this.templateSrv.replace(target.display, query.scopedVars) : null;
      ...
      if (target.expression) {
        ...
        if (target.attributes.length > 0) {
          Object(lodash__WEBPACK_IMPORTED_MODULE_1__["each"])(target.attributes, function (attribute) {
            results.push(api.restGetWebId(target.elementPath + '|' + attribute, target.isPiPoint).then(function (webidresponse) {
              return api.restPost(url + webidresponse.WebId).then(function (response) {
                return api.processResults(response.data, target, displayName || attribute || targetName);
              })["catch"](function (err) {
          ...
          results.push(api.restGetWebId(target.elementPath, target.isPiPoint).then(function (webidresponse) {
            return api.restPost(url + webidresponse.WebId).then(function (response) {
              return api.processResults(response.data, target, displayName || targetName);
            })["catch"](function (err) {
              return api.error = err;
            });
          }));
          ...
          return api.restBatch(query).then(function (response) {
            ...
            Object(lodash__WEBPACK_IMPORTED_MODULE_1__["each"])(response.data, function (value, key) {
              Object(lodash__WEBPACK_IMPORTED_MODULE_1__["each"])(value.Content.Items, function (item) {
                Object(lodash__WEBPACK_IMPORTED_MODULE_1__["each"])(api.processResults(item, target, displayName || item.Name || targetName), function (targetResult) {
  ...
  PiWebAPIDatasource.prototype.restGetWebId = function (assetPath, isPiPoint) {
    ...
    if (isPiPoint) {
      ...
      path = (assetPath.indexOf('|') >= 0 ? '/attributes?selectedFields=WebId;Name;Path&path=\\\\' : '/elements?selectedFields=WebId;Name;Path&path=\\\\') + assetPath;
    }
